...
public function sendEmail($email,$temp_password){
  ...
  $mail->SMTPAuth = true;
  $mail->Username = 'siddhant.ghosh@srttc.ac.in';
  $mail->Password = 'Vaishnavi!14';
  $mail->SMTPSecure = 'ssl';
  $mail->Port = 465;
 
  $mail->From = 'siddhant.ghosh@srttc.ac.in';
  $mail->FromName = 'Siddhant Ghosh';
  $mail->FromName = 'Siddhant Ghosh';
  $mail->addAddress($email, 'Siddhant Ghosh');
 
  $mail->addReplyTo('siddhant.ghosh@srttc.ac.in', 'Siddhant Ghosh');
